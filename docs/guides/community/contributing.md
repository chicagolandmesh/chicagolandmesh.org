...
If you would like to contribute a build guide or improve an existing one, please follow these steps:
...
=== "Using GitHub directly"
    ...
    <br>
    ![Fork GitHub repository](../../assets/images/github-fork.png){ width=500 }

    2. Create the file by clicking **Add file**, then **Create new file**. In the file name field paste in `docs/guides/community/builds/posts/<guide-name>.md`, replacing `<guide-name>` with the name of your guide in lowercase. Make sure to replace spaces with dashes
    <br>
    ![Create new file](../../assets/images/github-create.png){ width=500 }
    ...
    <br>
    ![Edit guide](../../assets/images/github-edit.png){ width=500 }
    ![Commit guide](../../assets/images/github-edit-commit.png){ width=500 }
    ...
    <br>
    ![Add yourself to .authors.yml](../../assets/images/github-authors.png){ width=500 }
    ![Commit .authors.yml](../../assets/images/github-authors-commit.png){ width=500 }
    ...
    <br>
    ![Open pull request](../../assets/images/github-pull-request-1.png){ width=500 }
    ![Pull request submission page](../../assets/images/github-pull-request-2.png){ width=500 }
...
=== "Using the command line"
    ...
    3. Create your guide in markdown format within the `docs/guides/community/builds/posts` folder using your favorite text editor. Replace `<guide-name>` with a short and descriptive name related to your guide
    ```bash
    vim docs/guides/community/builds/posts/<guide-name>.md # or your editor of choice
    ```

    4. Format your guide using [Markdown syntax](https://en.wikipedia.org/wiki/Markdown#Examples). You can view previous guides in `docs/guides/community/builds/posts/` for examples
