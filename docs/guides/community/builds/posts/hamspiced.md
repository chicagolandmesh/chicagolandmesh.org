...
Total Build Cost: $151.41 or $173.37 with Environment Sensor
...
2. Locate the area you want to install your antenna on the project box. All
   project box holes should be drilled on the bottom of the project box. Mark
   hole and drill with a 1/4" drill bit
3. If you are using the environment sensor locate the hole position for the
   sensor. Mark hole and drill with a 3/4" Drill bit
4. On the Lid of the project box, find center and mark an area for the solar
   panel controller to fit through so the pancel can sit flush. this is a 2"x
   1.5" rectangle. Cut out rectangle with an ocilating tool.
...
8. Apply Silicone sealant around the Solar Panel hole and in a circular pattern
   around the lid of the project box
9. Secure the solar panel to the lid of the project box threading the solar
   panel cables through the hole.
10. Let dry 12hrs to cure silicone
11. Secure wisblock and charge controller to the carrier board
12. Bend Tabs of the 18650 battery holder and solder jumpers to either end of
    the pads. 12. Run cables from positive and negative of battery to positive
    and negative B- and B+ of charge controller
13. Run USB From Solar panel to charge controller 14. Run Positive and Negative
    cables from Rak Wireless JST Cable to L+ and L- of charge controller
14. Attach and Secure IPEX to SMA cable from Rak Wireless board to Project Box.
15. Attach BT Antenna to Rak Wireless Nodes BT IPEX Connector
16. Attach Type N Cable to Antenna and secure to SMA connector on Project Box
17. Use Ubolt to attack Antenna and Project Box to Jpole
18. Attach Jpole Bracket to side of structure.
19. Position Jpole upright.
20. Position Project box and Solar array to point up facing South (North if you
    are in the South)
